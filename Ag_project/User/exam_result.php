			...
			<div style='margin:5%'><center>
				<?php
					...
					for($j=0; $j<count($var1); $j++)
					{
						...
						$total_que=$count+$cout+$not_attempt;


	  echo "<table > 
	  		<tr><td width='658'><center><table width='200' height='225'><tr><td><div class='abcd2'>Total Que. ".$total_que."</div></td></tr><tr><td><div class='abcd0'>Correct ".$count."</div></td></tr><tr><td><div class='abcd1'>Wrong ".$cout."</div></td></tr><tr><td><div class='abcd3'>Not Attempt ".$not_attempt."</div></td></tr><tr><td height='20' align='center'><button class='abcd' onclick='ShowDiv()'>Full Details <span><i class='fa fa-angle-double-right'></i></span></button><br></td></tr></table></center></td>
				<td>
...
for($j=0,$a = 1;$j<count($var1),$a <= count($var1);$a++,$j++)
{
	...
	if($var7[$j] == 's')
	{
		...
		{
			echo "<tr>";
			echo "<td bgcolor='#FFA500'; width='200';><center><span style='color:white'>". $a ."</span></center></td><td bgcolor='#0000FF'; width='200';><center><span style='color:white'>Not Attempt</span></center></td><td><a href='$solution?varname=$var1[$j]&var=$t_id' target=_blank>Click here</a></td></tr>";
		}
		else if($var2[$j] != $var3[$j])
		{
			echo "<tr>";
			echo "<td bgcolor='#FFA500'; width='200';><center><span style='color:white'>". $a ."</span></center></td><td bgcolor='#F00'; width='200';><center><span style='color:White'>Wrong</span><center></td><td><a href='$solution?varname=$var1[$j]&var=$t_id' target =_blank>Click here</a></td></tr>";
		}
